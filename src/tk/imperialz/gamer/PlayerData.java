...
public class PlayerData
{
    ...
    public void load() {
        ...
        try {
            ...
            final ResultSet result = statment.executeQuery("SELECT * FROM `KitPvP` WHERE `uuid` = '" + this.uuid.toString() + "';");
            if (result.next()) {
    ...
    public String toString() {
        return "PlayerData[UUID=" + this.uuid + ", NICK=" + this.nick + ", KILLS= " + this.kills + ", DEATHS=" + this.deaths + ", STREAK=" + this.streak + "]";
    }
}
