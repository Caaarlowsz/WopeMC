...
public class Placa implements Listener
{
    ...
    public void SignClickEvent(final PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && (e.getClickedBlock().getType() == Material.SIGN || e.getClickedBlock().getType() == Material.SIGN_POST || e.getClickedBlock().getType() == Material.WALL_SIGN)) {
            ...
            if (sign.getLine(0).equalsIgnoreCase("§a-§e-§b-§c-§d-") && sign.getLine(1).equalsIgnoreCase("§b§lPLACA") && sign.getLine(2).equalsIgnoreCase("Sopas") && sign.getLine(3).equalsIgnoreCase("§a-§e-§b-§c-§d-")) {
    ...
    public void SignClickEvent1(final PlayerInteractEvent e) {
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && (e.getClickedBlock().getType() == Material.SIGN || e.getClickedBlock().getType() == Material.SIGN_POST || e.getClickedBlock().getType() == Material.WALL_SIGN)) {
            final Sign sign = (Sign)e.getClickedBlock().getState();
            if (sign.getLine(0).equalsIgnoreCase("§a-§e-§b-§c-§d-") && sign.getLine(1).equalsIgnoreCase("§b§lPLACA") && sign.getLine(2).equalsIgnoreCase("Recraft") && sign.getLine(3).equalsIgnoreCase("§a-§e-§b-§c-§d-")) {
