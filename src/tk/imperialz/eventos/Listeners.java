...
{
    private static final WarpsMenu Menu;
    ...
    public void onJoin(final PlayerJoinEvent e) {
        ...
        if (p.hasPlayedBefore()) {
            ...
            }.runTaskLater((Plugin)Main.getPlugin((Class)Main.class), 15L);
        }
    }
    ...
    public void onDeath(final PlayerDeathEvent e) {
        ...
        if (e.getEntity().getKiller() instanceof Player) {
            ...
            if (dataKiller.getStreak() == 10) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l10");
            }
            else if (dataKiller.getStreak() == 15) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l15");
            }
            else if (dataKiller.getStreak() == 20) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l20");
            }
            else if (dataKiller.getStreak() == 25) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l25");
            }
            else if (dataKiller.getStreak() == 30) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l30");
            }
            else if (dataKiller.getStreak() == 35) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l35");
            }
            else if (dataKiller.getStreak() == 40) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l40");
            }
            else if (dataKiller.getStreak() == 45) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l45");
            }
            else if (dataKiller.getStreak() == 50) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l50");
            }
            else if (dataKiller.getStreak() == 55) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l55");
            }
            else if (dataKiller.getStreak() == 60) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l60");
            }
            else if (dataKiller.getStreak() == 65) {
                Bukkit.broadcastMessage("§c§lKILLSTREAK §e" + k.getName() + "§f alcan\u00e7ou um §4§lKILLSTREAK§f de §a§l65");
            }
        }
    }
    ...
    public void onSoup(final PlayerInteractEvent e) {
        ...
        if (hp.getHealth() != 20.0 && (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && p.getItemInHand().getTypeId() == 282) {
