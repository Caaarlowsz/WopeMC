...
public class ItemBuilder
{
    ...
    public static ItemStack criarItemInv(final Material mat, final String nome, final int quantidade, final int tipo, final int slot, final Inventory inv) {
        final ItemStack item = new ItemStack(mat, quantidade, (short)tipo);
        final ItemMeta itemm = item.getItemMeta();
        itemm.setDisplayName(nome);
        item.setItemMeta(itemm);
    ...
    public static ItemStack criarItem(final Material mat, final String nome, final Enchantment enchant, final int level) {
        final ItemStack item = new ItemStack(mat);
        final ItemMeta itemm = item.getItemMeta();
        itemm.addEnchant(enchant, level, true);
        itemm.setDisplayName(nome);
    ...
    public static ItemStack criarItem(final Material mat, final String nome, final int quantidade, final Enchantment enchant, final int level) {
        final ItemStack item = new ItemStack(mat, quantidade);
        final ItemMeta itemm = item.getItemMeta();
        itemm.addEnchant(enchant, level, true);
        itemm.setDisplayName(nome);
    ...
    public static ItemStack criarItem(final Material mat, final String nome, final int quantidade, final int tipo, final Enchantment enchant, final int level) {
        final ItemStack item = new ItemStack(mat, quantidade, (short)tipo);
        final ItemMeta itemm = item.getItemMeta();
        itemm.addEnchant(enchant, level, true);
        itemm.setDisplayName(nome);
