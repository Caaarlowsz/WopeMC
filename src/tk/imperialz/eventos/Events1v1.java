...
public class Events1v1 implements Listener
{
    ...
    public void PlayerInteractEntityEvent4(final PlayerInteractEntityEvent event) {
        ...
        if (p.getItemInHand().equals((Object)Join1v1.Item_)) {
            ...
            Player2.sendMessage("§6§l1V1 §fVoc\u00ea foi convidado pelo jogador §b" + p.getName() + " §fpara uma batalha 1v1");
    ...
    public void Morrer2(final PlayerDeathEvent e) {
        ...
        if (e.getEntity().getKiller() instanceof Player) {
            ...
            if (m != v) {
                ...
                m.sendMessage("     ");
                m.sendMessage("§6§l1V1 §fVoc\u00ea ganhou de jogador §b" + v.getName() + " §fe ele ficou com §c" + amountv + " §fsopas.");
                KitAPI.RemoveKit(m);
                KitAPI.RemoveKit(v);
                v.sendMessage("     ");
                v.sendMessage("§6§l1V1 §fVoc\u00ea perdeu para o jogador §b" + m.getName() + " §fe ele ficou com §c" + amountm + " §fsopas.");
                WarpsAPI.Ir(m, "1v1");
