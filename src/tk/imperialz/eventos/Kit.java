...
public class Kit implements Listener
{
    ...
    public static void inventariokits(final Player p) {
        ...
        final ItemStack ss = WarpsMenu.criarItemMenu(Material.CHEST, "§7Seus Kits", new String[1]);
    ...
    public void inventariowarps(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§7Menu de Warps") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
    ...
    public void inventariokitsevt2(final InventoryClickEvent e) {
        final Player p = (Player)e.getWhoClicked();
        if (e.getInventory().getTitle().equalsIgnoreCase("§7Seletor de Kits") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            ...
            if (e.getCurrentItem().getType() == Material.SPONGE) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.WOOD_HOE, ChatColor.GREEN + "Reaper", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.FEATHER) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.FEATHER, ChatColor.GREEN + "Phantom", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.IRON_FENCE) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.IRON_FENCE, ChatColor.GREEN + "Gladiator", new String[1], 1, (short)0));
                p.getInventory().setItem(2, APITag.criarItem(p, Material.COBBLESTONE, ChatColor.GREEN + "Blocos", new String[1], 16, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.LEASH) {
                ...
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                p.getInventory().setItem(1, APITag.criarItem(p, Material.LEASH, ChatColor.GREEN + "Grappler", new String[1], 1, (short)0));
                return;
            }
            if (e.getCurrentItem().getType() == Material.DIAMOND_AXE) {
                ...
                p.getInventory().setItem(0, APITag.criarItem(p, Material.STONE_AXE, ChatColor.GREEN + "Viking", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.GRAVEL) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.TNT, ChatColor.GREEN + "Demoman", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.WOOD_AXE) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.WOOD_AXE, ChatColor.GREEN + "Thor", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            if (e.getCurrentItem().getType() == Material.EMERALD) {
            ...
            if (e.getCurrentItem().getType() == Material.BLAZE_ROD) {
                ...
                KitAPI.DarSopa(p);
                p.getInventory().setItem(1, APITag.criarItem(p, Material.BLAZE_ROD, ChatColor.GREEN + "Monk", new String[1], 1, (short)0));
                return;
            }
            if (e.getCurrentItem().getType() == Material.FIREWORK) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.FIREWORK, ChatColor.GREEN + "Kangaroo", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            ...
            if (e.getCurrentItem().getType() == Material.BOOK) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.BOOK, ChatColor.GREEN + "Specialist", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
            ...
            if (e.getCurrentItem().getType() == Material.FISHING_ROD) {
                ...
                p.getInventory().setItem(1, APITag.criarItem(p, Material.FISHING_ROD, ChatColor.GREEN + "Fisherman", new String[1], 1, (short)0));
                p.playSound(p.getLocation(), Sound.LEVEL_UP, 2.0f, 2.0f);
                return;
            }
